...
schemaType: "HowTo"
sources:
  - { title: "Securely using pull_request_target", url: "https://docs.github.com/en/actions/reference/security/securely-using-pull_request_target", publication: "GitHub Docs", year: "2026 accessed" }
  - { title: "Events that trigger workflows", url: "https://docs.github.com/en/actions/reference/workflows-and-actions/events-that-trigger-workflows#pull_request_target", publication: "GitHub Docs", year: "2026 accessed" }
  - { title: "Secure use reference", url: "https://docs.github.com/en/actions/reference/security/secure-use", publication: "GitHub Docs", year: "2026 accessed" }
  - { title: "Automatic token authentication", url: "https://docs.github.com/en/actions/tutorials/authenticate-with-github_token", publication: "GitHub Docs", year: "2026 accessed" }
  - { title: "Workflow syntax: permissions", url: "https://docs.github.com/en/actions/reference/workflows-and-actions/workflow-syntax#permissions", publication: "GitHub Docs", year: "2026 accessed" }
  - { title: "Approving workflow runs from public forks", url: "https://docs.github.com/en/actions/how-tos/manage-workflow-runs/approve-runs-from-forks", publication: "GitHub Docs", year: "2026 accessed" }
  - { title: "Security hardening for GitHub Actions", url: "https://docs.github.com/en/actions/security-for-github-actions/security-guides/security-hardening-for-github-actions", publication: "GitHub Docs", year: "2026 accessed" }
  - { title: "GitHub Actions: Preventing pwn requests", url: "https://securitylab.github.com/resources/github-actions-preventing-pwn-requests/", publication: "GitHub Security Lab", year: "2021" }
  - { title: "Using OpenID Connect with reusable workflows", url: "https://docs.github.com/en/actions/how-tos/security-for-github-actions/security-hardening-your-deployments/using-openid-connect-with-reusable-workflows", publication: "GitHub Docs", year: "2026 accessed" }
internalLinks:
...
For release evidence, Toolspilot’s [vendor security evidence-folder checklist](/posts/vendor-security-evidence-folder-checklist-2026/) explains provenance. Attestation can show which workflow produced an artifact; it does not transform a fork-controlled build into trusted release input.
