...
sources:
  ...
  - title: "Small organisations guide to cyber security"
    ...
    year: "2026 accessed"
internalLinks:
  - "/posts/local-first-notes-backup-migration-checklist-2026/"
  - "/posts/ai-coding-agent-repository-safety-checklist-2026/"
  - "/posts/npm-install-script-safety-review-checklist-2026/"
visualsCount: 5
hasVideo: false
wordCount: 2300
affiliate: false
...
Use the [local-first notes backup and migration checklist](/posts/local-first-notes-backup-migration-checklist-2026/) when the source is a file-based notes system. Review the [AI coding agent repository safety checklist](/posts/ai-coding-agent-repository-safety-checklist-2026/) before letting automation touch repositories or credentials, and the [npm install-script safety review](/posts/npm-install-script-safety-review-checklist-2026/) before adding recovery tooling to a privileged environment.
