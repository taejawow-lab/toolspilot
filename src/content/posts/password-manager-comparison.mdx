...
faq:
  ...
  - question: "Is the free tier of Bitwarden enough?"
    answer: "Yes for most individuals. Free Bitwarden offers unlimited passwords, unlimited devices, secure password generation, and 2FA storage. Pay 10 dollars per year only if you need (1) family sharing for 6 users, (2) emergency access, or (3) advanced reports. Free tier covers core use case completely."
  - question: "Should I use the password manager built into my browser?"
    answer: "Not as primary tool. Browser managers (Chrome, Safari) lack cross-browser sync, weaker against malware, and limited to browser context. They are acceptable for low-value sites but use Bitwarden or 1Password for all important accounts (email, banking, crypto, work)."
  - question: "Do I need a hardware security key?"
    answer: "Yes for email, banking, and crypto accounts. Hardware keys (YubiKey, Titan) prevent phishing in ways SMS and authenticator apps cannot. Buy 2 keys (primary plus backup), set up FIDO2 on critical accounts. Cost 50 to 80 dollars total. ROI: complete protection against credential phishing."
  - question: "What if I forget my master password?"
    answer: "Most password managers offer Emergency Access (Bitwarden Premium, 1Password Families). Configure a trusted contact who can request access after a waiting period. Without it, encrypted vault is unrecoverable. Print recovery code and store in a safe. Master password loss is the number-one user pain point. Plan ahead."
---
