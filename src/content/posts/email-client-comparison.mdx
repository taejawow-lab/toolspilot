...
faq:
  - question: "Should I pay for an email client?"
    answer: "Most users don't need to. Gmail (free) and Outlook (free with Microsoft account) handle 80% of use cases. Pay only if (1) you need encryption (ProtonMail), (2) advanced inbox triage (Superhuman, HEY), or (3) team features (Front, Spike). Free options have caught up to most paid features."
  - question: "Is ProtonMail necessary for privacy?"
    answer: "If you're a journalist, lawyer, or handle sensitive information, yes. For typical users, Gmail's encryption-at-rest and 2FA provide adequate security. ProtonMail's zero-knowledge encryption means even Proton can't read your email ??useful for whistleblowers, threatened individuals, and crypto holders managing valuable accounts."
  - question: "Does HEY's workflow actually work?"
    answer: "It transforms email habits for users overwhelmed by inbox volume. The screener forces decisions, paper trail organizes by relationship, and reply later prevents urgent-but-not-important interruptions. Trade-off: lock-in to HEY's address (\/year). Worth trying for 30-day free trial if email is a daily stress source."
  ...
  - question: "How do I handle multiple email accounts?"
    answer: "Use a unified inbox app ??Spark and Spike show all accounts in one stream with smart filters. Or use one client (Outlook, Apple Mail) configured for multiple IMAP accounts. Avoid switching between separate clients per account ??single workflow reduces missed messages."
---
